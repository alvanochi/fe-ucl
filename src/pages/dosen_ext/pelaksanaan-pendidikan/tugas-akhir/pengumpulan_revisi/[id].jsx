        ...
        <Card className="mt-4">
          ...
          <Card.Body className="space-y-4">
            ...
            <Form.Group className="flex items-baseline gap-3">
              ...
              <span>:</span>
              <Form.Input type="file" className="flex-1" name="lembar_pengesahan" disabled />
            </Form.Group>
            {form.lembar_pengesahan && typeof form.lembar_pengesahan !== 'object' && (
              <Form.Group className="flex items-baseline gap-3">
            ...
            <Form.Group className="flex items-baseline gap-3">
              ...
              <span>:</span>
              <Form.Input type="file" className="flex-1" name="dokumen_skripsi" disabled />
            </Form.Group>
            {form.dokumen_skripsi && typeof form.dokumen_skripsi !== 'object' && (
              <Form.Group className="flex items-baseline gap-3">
                <Form.Label className="min-w-[20rem]"></Form.Label>
                <embed
