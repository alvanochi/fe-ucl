...
const DokumenEdit = () => {
  ...
  const API_URL = `${process.env.NEXT_PUBLIC_API_URL}/pengabdian/pembicara/detailDokumen`
  ...
  const EDIT_URL = `${process.env.NEXT_PUBLIC_API_URL}/pengabdian/pembicara/editDokumen`
  const EDIT_OPTION = {
  ...
  return (
    <Layout>
      ...
      <Form onSubmit={event => submitHandler(event, EDIT_OPTION)} type="formdata">
        <Card className="mt-4">
          <Card.Header className="text-center">Edit Dokumen Pembicara</Card.Header>
        ...
        <div className="flex gap-4 mt-4">
          <Button
            as="a"
            href={`${prefix + menu.url}/pembicara/edit/${form.pembicara}`}
            variant="secondary"
