...
const DokumenEdit = () => {
  ...
  const API_URL = `${process.env.API_ENDPOINT}/pengabdian/pembicara/detailDokumen`;
  ...
  const EDIT_URL = `${process.env.API_ENDPOINT}/pengabdian/pembicara/editDokumen`;
  const EDIT_OPTION = {
