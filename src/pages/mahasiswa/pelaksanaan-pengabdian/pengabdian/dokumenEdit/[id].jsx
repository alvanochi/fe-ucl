...
const DokumenEdit = () => {
  ...
  const API_URL = `${process.env.NEXT_PUBLIC_API_URL}/pengabdian/detailDokumen`
  ...
  const EDIT_URL = `${process.env.NEXT_PUBLIC_API_URL}/pengabdian/editDokumen`
  const EDIT_OPTION = {
  ...
  return (
    <Layout>
      ...
      <Form onSubmit={event => submitHandler(event, EDIT_OPTION)} type="formdata">
        <Card className="mt-4">
          <Card.Header className="text-center">Edit Dokumen Pengabdian</Card.Header>
