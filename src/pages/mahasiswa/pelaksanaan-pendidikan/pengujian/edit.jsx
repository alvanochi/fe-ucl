				...
				<Card className="mt-4">
					...
					<Card.Body className="space-y-4">
						...
						<Form.Group className="flex items-baseline gap-3">
							...
							<span>:</span>
							<Form.Input type="text" className="flex-1" value="Bogor" />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
							...
							<span>:</span>
							<Form.Input type="text" className="flex-1" value="291/K.1/TI-FT/IX/2019" />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
							...
							<span>:</span>
							<Form.Input type="date" className="flex-1" value="2019-09-10" />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
							...
							<span>:</span>
							<Form.Input type="text" className="flex-1" value="Kolokium" />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
						...
						<Form.Group className="flex items-baseline gap-3">
							...
							<span>:</span>
							<Form.Input type="text" className="flex-1" value="2021/2022 Genap" />
						</Form.Group>
					</Card.Body>
				</Card>
				<table className="w-full border-collapse rounded-2xl overflow-hidden shadow table-auto mt-4" cellPadding={10}>
					...
					<tbody>
						<tr>
							...
							<td className="text-sm border-2 border-white bg-gray-50">
								<Form.Input type="number" min="0" value="1" />
							</td>
						...
						<tr>
							...
							<td className="text-sm border-2 border-white bg-gray-50">
								<Form.Input type="number" min="0" value="2" />
							</td>
