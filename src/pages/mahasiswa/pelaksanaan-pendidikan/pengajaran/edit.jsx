...
export default function PengajaranEdit() {
				...
				<Card className="mt-4">
					...
					<Card.Body className="space-y-4">
						...
						<Form.Group className="flex items-baseline gap-3">
							...
							<span>:</span>
							<Form.Input type="number" min="0" className="flex-1" value="23" />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
							...
							<span>:</span>
							<Form.Input type="number" min="0" max="3" className="flex-1" value="2" />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
							...
							<span>:</span>
							<Form.Input type="number" min="1" max="16" className="flex-1" value="5" />
						</Form.Group>
					</Card.Body>
				</Card>
