...
export default function PenghargaanDetail() {
	...
	const file = URL.createObjectURL(dummyFile);
	...
	return (
		<Layout>
			...
			<div className="flex justify-center mt-4">
				<Button
					as="a"
					href={`${prefix + menu.url}/tugas-tambahan/edit`}
					variant="secondary"
				...
				<Card className="mt-4">
					...
					<Card.Body className="space-y-4">
						...
						<Form.Group className="flex items-baseline gap-3">
							...
							<span>:</span>
							<Form.Input type="number" min="1" className="flex-1" value="8" disabled />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
							...
							<span>:</span>
							<Form.Input type="text" className="flex-1" value="194/KEP/UIKA/2020" disabled />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
							...
							<span>:</span>
							<Form.Input type="date" className="flex-1" value="2020-11-28" disabled />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
							...
							<span>:</span>
							<Form.Input type="date" className="flex-1" value="2024-11-28" disabled />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
							...
							<span>:</span>
							<embed src={file} className="w-full h-[256px]" />
						</Form.Group>
					</Card.Body>
				</Card>
