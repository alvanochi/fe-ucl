    ...
    <Layout>
      ...
      >
        ...
        <div>
          ...
          <span className="text-danger-600">*</span>), data akan dilengkapi oleh Tata Usaha Program
          Studi jika status approved dosen pembimbing sudah diceklis. dan pastikan semua link google
          drive bisa di akses oleh siapa saja yang memiliki link!
        </div>
      </div>
        ...
        <Card className="mt-4">
          ...
          <Card.Body className="space-y-4">
            ...
            <Form.Group className="flex items-baseline gap-3">
              ...
              <span>:</span>
              <Form.Input type="text" className="flex-1" name="email" value={form.email} disabled />
            </Form.Group>
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">
              ...
              <span>:</span>
              <Form.Input type="text" className="flex-1" name="no_hp" value={form.no_hp} disabled />
            </Form.Group>
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">
            ...
            <Form.Group className="flex items-baseline gap-3">
              ...
              <span>:</span>
              <Form.Input type="text" className="flex-1" name="wali" value={form.wali} disabled />
            </Form.Group>
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">
        ...
        <Card className="mt-4">
          ...
          <Card.Body className="space-y-4">
            ...
            <Form.Group className="flex items-baseline gap-3">
              ...
              <span>:</span>
              <Form.Input type="file" className="flex-1" name="pas_foto" onChange={inputHandler} />
            </Form.Group>
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">
                Ijazah Terakhir 1 Lembar <span className="text-danger-600">*</span>
              </Form.Label>
              <span>:</span>
              <Form.Input
                type="text"
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">
                Photocopy Sertifikat Ta aruf <span className="text-danger-600">*</span>
              </Form.Label>
              <span>:</span>
              <Form.Input
                type="text"
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">
                Sertifikat Leadership Camp(LKKM) FTS <span className="text-danger-600">*</span>
              </Form.Label>
              <span>:</span>
              <Form.Input
                type="text"
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">
                2 Sertifikat Kompetensi <span className="text-danger-600">*</span>
              </Form.Label>
              <span>:</span>
              <Form.Input
                type="text"
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">
                Bukti Upload Jurnal/LOA <span className="text-danger-600">*</span>
              </Form.Label>
              <span>:</span>
              <Form.Input
                type="text"
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">
                Photocopy Sertifikat TOFL <span className="text-danger-600">*</span>
              </Form.Label>
              <span>:</span>
              <Form.Input
                type="text"
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">
                ...
                <p>
                  (SPP, SKS, Konversi) <span className="text-danger-600">*</span>
                </p>
              </Form.Label>
              <span>:</span>
              <Form.Input
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">Lulus Semua Matakuliah Lokal</Form.Label>
              <span>:</span>
              <Form.Checkbox type="checkbox" name="status_mk" disabled checked={form.status_mk} />
            </Form.Group>
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">Maksimal Nilai D Berjumlah 1</Form.Label>
              <span>:</span>
              <Form.Checkbox
                type="checkbox"
                name="max_nilai_d"
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">Minimal IPK ≥ 2,00</Form.Label>
              <span>:</span>
              <Form.Checkbox
                type="checkbox"
                name="status_min_ipk"
          ...
          <Card.Header className="text-center">
            ...
            <div className="mt-2">
              <span className="font-normal">
                ...
                <span className="text-danger-600">*</span>), data akan dilengkapi oleh Tata Usaha
                Program Studi jika status approved dosen pembimbing sudah diceklis.
              </span>
            </div>
          </Card.Header>
          ...
          <Card.Body className="space-y-4">
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">
                ...
                <p>
                  Lampirkan Seluruh Transkip Nilai <span className="text-danger-600">*</span>
                </p>
              </Form.Label>
              <span>:</span>
              <Form.Input
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[20rem]">
                Link Dokumen Draft Final Skripsi <span className="text-danger-600">*</span>
              </Form.Label>
              <span>:</span>
              <Form.Input
                type="text"
          ...
          <tbody>
            <tr>
              <td className="text-sm border-2 border-white text-center font-bold">
                <span>Pembimbing 1</span> <span className="text-danger-600">*</span>
              </td>
              ...
              <td className="text-sm border-2 border-white">
                <Form.Group className="flex items-center justify-center gap-3">
                  <input
                    ...
                    type="checkbox"
                    checked={form.sidang_status_pem_1 ? true : false}
              ...
              <td className="text-sm border-2 border-white">
                <Form.Group className="flex items-center justify-center gap-3">
                  <input
                    className="cursor-pointer"
                    type="checkbox"
                    checked={form.sidang_status_pem_2 ? true : false}
