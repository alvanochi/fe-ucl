...
export default function PendidikanFormalDetial() {
  ...
  const API_URL = `${process.env.NEXT_PUBLIC_API_URL}/kualifikasi/detailPend`
  const FILE_URL = `${process.env.NEXT_PUBLIC_API_URL}/file-pendFormal`
        ...
        <Card className="mt-4">
          ...
          <Card.Body className="space-y-4">
            ...
            <Form.Group className="flex items-baseline gap-3">
              ...
              <span>:</span>
              <Form.Input type="text" className="flex-1" name="asal" value={form.asal} disabled />
            </Form.Group>
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[18rem]">
