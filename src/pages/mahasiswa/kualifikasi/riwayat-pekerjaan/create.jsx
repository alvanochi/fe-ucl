					...
					<Card.Body className="space-y-4">
						<Form.Group className="flex items-baseline gap-3">
							...
							<Form.Select
								...
								options={[
									{ value: "Pertanian, Kehutanan dan Perikanan", label: "Pertanian, Kehutanan dan Perikanan" },
									{ value: "Pertambangan dan Penggalian", label: "Pertambangan dan Penggalian" },
									{ value: "Industri Pengolahan", label: "Industri Pengolahan" },
									{
									...
									},
									{
										...
										label: "Pengelolaan Air, Pengelolaan Air Limbah, Pengelolaan dan Daur Ulang Sampah, dan Aktivitas Remediasi",
									},
									...
									{ value: "Pengangkutan dan pergudangan", label: "Pengangkutan dan pergudangan" },
									{
										value: "Penyediaan Akomodasi Dan Penyediaan Makan Minum",
										label: "Penyediaan Akomodasi Dan Penyediaan Makan Minum",
									},
									{ value: "Informasi Dan Komunikasi", label: "Informasi Dan Komunikasi" },
									{ value: "Aktivitas Keuangan Dan Asuransi", label: "Aktivitas Keuangan Dan Asuransi" },
									...
									{
										value: "Aktivitas Penyewaan dan Sewa Guna Usaha Tanpa Hak Opsi, Ketenagakerjaan, Agen Perjalanan dan Penunjang Usaha Lainnya",
										label: "Aktivitas Penyewaan dan Sewa Guna Usaha Tanpa Hak Opsi, Ketenagakerjaan, Agen Perjalanan dan Penunjang Usaha Lainnya",
									},
									{
									...
									{ value: "Kesenian, Hiburan Dan Rekreasi", label: "Kesenian, Hiburan Dan Rekreasi" },
									{ value: "Aktivitas Jasa Lainnya", label: "Aktivitas Jasa Lainnya" },
									{
						...
						<Form.Group className="flex items-baseline gap-3">
							...
							<span>:</span>
							<Form.Input type="text" className="flex-1" name="jabatan" onChange={inputHandler} value={form.jabatan} />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
						...
						<Form.Group className="flex items-baseline gap-3">
							...
							<span>:</span>
							<Form.Input type="text" className="flex-1" name="divisi" onChange={inputHandler} value={form.divisi} />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
							...
							<span>:</span>
							<Form.Textarea className="flex-1" rows="5" name="deskripsi" onChange={inputHandler} value={form.deskripsi} />
						</Form.Group>
						<Form.Group className="flex items-baseline gap-3">
							<Form.Label className="min-w-[18rem]">
						...
						<Form.Group className="flex items-baseline gap-3">
							...
							<span>:</span>
							<Form.Input type="file" className="flex-1" name="file_rwyt_pekerjaan" onChange={inputHandler} />
						</Form.Group>
					</Card.Body>
				</Card>
