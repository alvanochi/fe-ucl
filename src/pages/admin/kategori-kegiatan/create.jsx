...
const CreateKategoriKegiatan = ({ onAction }) => {
  ...
  const { form, inputHandler } = useForm(INITIAL_FORM, {
    rules: [{ field: 'nama_kegiatan', label: 'nama_kegiatan' }],
  })
  ...
  async function submitHandler(event) {
    ...
    try {
      ...
      const request = await axios({
        url: `${process.env.NEXT_PUBLIC_API_URL}/kategori/kegiatan`,
        method: 'POST',
        data: requestData,
      })
  ...
  return (
    <>
      ...
      <Modal title="Tambah Kategori Kegiatan" show={show} handler={toggle}>
