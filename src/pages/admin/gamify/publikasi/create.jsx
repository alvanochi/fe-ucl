...
export default function PublikasiGamifyCreate() {
  ...
  return (
    <Layout>
      ...
      <Form onSubmit={submitHandler}>
        <Card className="mt-4">
          <Card.Header className="text-center">Tambah Kategori Publikasi</Card.Header>
          <Card.Body className="space-y-4">
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[18rem]">
                Tingkat <span className="text-danger-600">*</span>
              </Form.Label>
              <span>:</span>
              <Form.Input
                type="text"
