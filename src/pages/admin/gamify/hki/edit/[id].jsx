...
export default function DetailKategoriHki() {
  ...
  const EDIT_URL = `${process.env.NEXT_PUBLIC_API_URL}/kategori/hki`
  ...
  return (
    <Layout>
      ...
      <Form onSubmit={event => submitHandler(event, EDIT_OPTION)}>
        <Card className="mt-4">
          <Card.Header className="text-center">Edit Kategori HKI</Card.Header>
