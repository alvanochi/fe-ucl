...
export const Login = () => {
  ...
  const settings = {
    ...
    customPaging: function (i) {
      return <div className="w-full h-1 bg-white rounded-full bg-opacity-20 dots"></div>
    },
  }
  ...
  async function submitHandler(event) {
    ...
    try {
      ...
      if (error.name === 'AxiosError') {
        ...
        if (message == 'Account not verified. Check your email for verification.') {
          ...
          <div className={`block ${stylesPage.formContainer}`}>
            <div className="block mb-2">
              ...
              <p className="block text-sm text-gray-600">
                Selamat datang di UCL. Kami merekomendasikan untuk login menggunakan perangkat
                dengan layar berukuran desktop.
              </p>
            </div>
            ...
            <div className="relative block mb-6">
              <div className="flex items-baseline justify-between">
                ...
                <Link href="/forgot-password" className="text-sm font-medium text-primary-600">
                  Lupa kata sandi?
                </Link>
              </div>
              <input
              ...
              >
                {showPassword ? (
                  <Icon icon="solar:eye-bold" className="text-gray-600" width={20} height={20} />
                ) : (
            ...
            >
              <img src="/img/google.png" alt="Google Logo" className="w-6 h-6 mr-2" />
