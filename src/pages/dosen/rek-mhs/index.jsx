            ...
            data.map((row, index) => (
              <div key={`row-${index}`}>
                <Link href={`${prefix + menu.url}/detail-mhs/${row.user_id}`}>
                  <div
                    className={`max-w-md mx-auto cursor-pointer bg-white rounded-xl shadow-md overflow-hidden md:max-w-4xl m-5 relative ${styles.card}`}
                  >
                    <div className="md:flex relative">
                      ...
                      <div className="pl-8 pt-2 pb-2 md:flex-grow relative">
                        ...
                        <h1 className="absolute text-right top-1/2 transform -translate-y-1/2 right-8 text-lg font-bold text-blue-900">
                          {row.rank} | {row.total_point}
                        </h1>
                      </div>
                    </div>
                  </div>
