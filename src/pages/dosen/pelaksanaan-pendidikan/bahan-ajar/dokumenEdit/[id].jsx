...
const DokumenEdit = () => {
  ...
  const API_URL = `${process.env.NEXT_PUBLIC_API_URL}/pendidikan/bahan-ajar/detailDokumen`
  ...
  const EDIT_URL = `${process.env.NEXT_PUBLIC_API_URL}/pendidikan/bahan-ajar/editDokumen`
  const EDIT_OPTION = {
  ...
  return (
    <Layout>
      ...
      <Form onSubmit={event => submitHandler(event, EDIT_OPTION)} type="formdata">
        <Card className="mt-4">
          <Card.Header className="text-center">Edit Dokumen Penelitian</Card.Header>
        ...
        <div className="flex gap-4 mt-4">
          <Button
            as="a"
            href={`${prefix + menu.url}/penelitian/edit/${form.bahan_ajar_id}`}
            variant="secondary"
