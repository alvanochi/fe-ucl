...
export default function AnggotaProfesiEdit() {
	...
	const EDIT_OPTION = { url: `${EDIT_URL}/${form.penelitian_id}`, method: "PATCH" };
	...
	useEffect(() => {
		...
		show(router.query.id, {
			transformData: (data) => ({
				...
				anggota_penelitian_mahasiswa: data.anggotaPenelitian.filter((item) => item.role == ROLE_ID_MAHASISWA),
