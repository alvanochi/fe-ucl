...
export default function JabatanFungsionalCreate() {
  ...
  const API_URL = `${process.env.NEXT_PUBLIC_API_URL}/profile/addJabatan`
  const INITIAL_FORM = {
    jabatan_fungsi: '',
    nomor_sk: '',
    tgl_mulai: '',
  ...
  return (
    <Layout>
      <PageHeader title={`Add Kepangkatan`} icon={menu.icon} handler={setActive} />
      <Form onSubmit={submitHandler} type="formdata">
        <Card className="mt-4">
          ...
          <Card.Body className="space-y-4">
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[18rem]">Kelebihan Penelitian</Form.Label>
              <span>:</span>
              <Form.Input
                type="number"
                min="0"
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[18rem]">Kelebihan Pengabdian Masyarakat</Form.Label>
              <span>:</span>
              <Form.Input
                type="number"
                min="0"
            ...
            <Form.Group className="flex items-baseline gap-3">
              <Form.Label className="min-w-[18rem]">Kelebihan Kegiatan Penunjang</Form.Label>
              <span>:</span>
              <Form.Input
                type="number"
                min="0"
