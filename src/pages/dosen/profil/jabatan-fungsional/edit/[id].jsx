...
export default function JabatanFungsionalEdit() {
  ...
  const API_URL = `${process.env.NEXT_PUBLIC_API_URL}/profile/detailDataJabatan`
  const FILE_URL = `${process.env.NEXT_PUBLIC_API_URL}/file-jabatan`
  ...
  const EDIT_URL = `${process.env.NEXT_PUBLIC_API_URL}/profile/editDataJabatan`
  const EDIT_OPTION = {
    url: `${EDIT_URL}/${form.jabatan_id}`,
    method: 'PATCH',
  }
