...
export default function SertifikasiGamifyModule({ baseURL }) {
  const API_URL = `${process.env.NEXT_PUBLIC_API_URL}/kategori/sertifikasi`
              ...
              <tr key={`row-${index}`}>
                ...
                <td className="text-sm border-2 border-white bg-gray-50">
                  <div className="flex items-stretch gap-1">
                    <Button.Icon
                      as="a"
                      href={`${baseURL}/sertifikasi/edit/${row.id}`}
                      variant="secondary"
