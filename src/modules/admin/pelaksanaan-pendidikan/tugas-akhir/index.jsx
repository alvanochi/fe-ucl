...
export default function TugasAkhirModule({ baseURL }) {
  const DATA_URL = `${process.env.NEXT_PUBLIC_API_URL}/tugas-akhir/get-for-admin`
  ...
  const DELETE_URL = `${process.env.NEXT_PUBLIC_API_URL}/tugas-akhir`
      ...
      <div className="flex mb-8 justify-end items-center">
        <div className="flex items-center mr-4">
          ...
          <Button
            variant="danger"
            className="ml-4"
            onClick={() => window.open(`${baseURL}/tugas-akhir/rekapitulasi-nilai`, '_blank')}
            icon={<Icon icon="material-symbols-light:assignment-rounded" width={20} height={20} />}
            pill
          >
            Rekapitulasi Nilai
          </Button>
      ...
      <table className="w-full border-collapse rounded-2xl shadow table-auto" cellPadding={10}>
        <thead>
          <tr>
            ...
            <th className="text-sm border-2 border-white bg-gray-200">
              <div className="flex items-center gap-2 cursor-pointer">Status Dospem</div>
            </th>
            ...
            dataNew.map((row, index) => {
              ...
              return (
                <tr key={`row-${index}`}>
                  ...
                  <td className="text-sm border-2 border-white bg-gray-50 ">{row.status}</td>
                  ...
                  <td className="text-sm border-2 border-white bg-gray-50">{row.statusDospem}</td>
