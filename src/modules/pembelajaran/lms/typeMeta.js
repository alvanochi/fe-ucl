...
export const CONTENT_TYPE_META = {
  ...
  ppt: { label: "Presentasi", icon: "mdi:file-powerpoint-box", color: "text-orange-600", bg: "bg-orange-100", desc: "Slide presentasi (PowerPoint) yang dapat dibaca langsung atau diunduh." },
